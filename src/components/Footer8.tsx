...
export const Footer8Defaults: Footer8Props = {
  logo: {
    url: "#",
    src: "/assets/images/primary-logo",
    alt: "Logo image",
  },
  ...
  columnLinks: [
    {
      links: [
        ...
        { title: "Asset Management", url: "/services/asset-management" },
        { title: "Project & Programme Management", url: "/services/project-management" },
        { title: "Operations & Maintenance", url: "/services/operations-maintenance" },
